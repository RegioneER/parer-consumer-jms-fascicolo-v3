...
Microservizio adibito al consumo dei messaggi inviati sulla coda ProducerCodaVersFascicoliQueue da parte di Preingest e al versamento dei fascicoli ricevuti nel messaggio ai webservice di versamento di Sacer.
...
Per la creazione dell'applicazione con risorse necessarie correlate sotto Openshift (https://www.redhat.com/it/technologies/cloud-computing/openshift) viene fornito un apposito template (la soluzione, modificabile, è basata su Oracle DB) [template](src/main/openshift/consumer-jms-fascicolo-template.yml).
...
|io.agroal|agroal-api|2.7.1|
|io.agroal|agroal-narayana|2.7.1|
|io.agroal|agroal-pool|2.7.1|
...
|io.quarkiverse.artemis|quarkus-artemis-core|3.6.0|
|io.quarkiverse.artemis|quarkus-artemis-jms|3.6.0|
|io.quarkus.arc|arc|3.24.2|
|io.quarkus.gizmo|gizmo|1.9.0|
|io.quarkus.qute|qute-core|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive-client|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive-common-types|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive-common|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive-jackson|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive-vertx|3.24.2|
|io.quarkus.resteasy.reactive|resteasy-reactive|3.24.2|
|io.quarkus.security|quarkus-security|2.2.1|
|io.quarkus.vertx.utils|quarkus-vertx-utils|3.24.2|
|io.quarkus|quarkus-agroal|3.24.2|
|io.quarkus|quarkus-arc|3.24.2|
|io.quarkus|quarkus-bootstrap-app-model|3.24.2|
|io.quarkus|quarkus-bootstrap-core|3.24.2|
|io.quarkus|quarkus-bootstrap-gradle-resolver|3.24.2|
|io.quarkus|quarkus-bootstrap-maven-resolver|3.24.2|
|io.quarkus|quarkus-bootstrap-runner|3.24.2|
|io.quarkus|quarkus-builder|3.24.2|
|io.quarkus|quarkus-caffeine|3.24.2|
|io.quarkus|quarkus-class-change-agent|3.24.2|
|io.quarkus|quarkus-classloader-commons|3.24.2|
|io.quarkus|quarkus-config-yaml|3.24.2|
|io.quarkus|quarkus-core-deployment|3.24.2|
|io.quarkus|quarkus-core|3.24.2|
|io.quarkus|quarkus-credentials|3.24.2|
|io.quarkus|quarkus-datasource-common|3.24.2|
|io.quarkus|quarkus-datasource|3.24.2|
|io.quarkus|quarkus-development-mode-spi|3.24.2|
|io.quarkus|quarkus-devtools-utilities|3.24.2|
|io.quarkus|quarkus-elytron-security-common|3.24.2|
|io.quarkus|quarkus-elytron-security-properties-file|3.24.2|
|io.quarkus|quarkus-elytron-security|3.24.2|
|io.quarkus|quarkus-fs-util|1.0.0|
|io.quarkus|quarkus-hibernate-orm|3.24.2|
|io.quarkus|quarkus-hibernate-validator-spi|3.24.2|
|io.quarkus|quarkus-ide-launcher|3.24.2|
|io.quarkus|quarkus-jackson|3.24.2|
|io.quarkus|quarkus-jaxb|3.24.2|
|io.quarkus|quarkus-jaxp|3.24.2|
|io.quarkus|quarkus-jdbc-oracle|3.24.2|
|io.quarkus|quarkus-jsonp|3.24.2|
|io.quarkus|quarkus-junit5-config|3.24.2|
|io.quarkus|quarkus-junit5|3.24.2|
|io.quarkus|quarkus-logging-json|3.24.2|
|io.quarkus|quarkus-mutiny|3.24.2|
|io.quarkus|quarkus-narayana-jta|3.24.2|
|io.quarkus|quarkus-netty|3.24.2|
|io.quarkus|quarkus-qute|3.24.2|
|io.quarkus|quarkus-rest-client-config|3.24.2|
|io.quarkus|quarkus-rest-client-jackson|3.24.2|
|io.quarkus|quarkus-rest-client-jaxrs|3.24.2|
|io.quarkus|quarkus-rest-client|3.24.2|
|io.quarkus|quarkus-rest-common|3.24.2|
|io.quarkus|quarkus-rest-jackson-common|3.24.2|
|io.quarkus|quarkus-rest-jackson|3.24.2|
|io.quarkus|quarkus-rest-jaxb|3.24.2|
|io.quarkus|quarkus-rest-qute|3.24.2|
|io.quarkus|quarkus-rest|3.24.2|
|io.quarkus|quarkus-security-jpa-common|3.24.2|
|io.quarkus|quarkus-security-jpa|3.24.2|
|io.quarkus|quarkus-security-runtime-spi|3.24.2|
|io.quarkus|quarkus-security|3.24.2|
|io.quarkus|quarkus-smallrye-context-propagation|3.24.2|
|io.quarkus|quarkus-smallrye-health|3.24.2|
|io.quarkus|quarkus-smallrye-openapi|3.24.2|
|io.quarkus|quarkus-swagger-ui|3.24.2|
|io.quarkus|quarkus-test-common|3.24.2|
|io.quarkus|quarkus-test-security|3.24.2|
|io.quarkus|quarkus-tls-registry-spi|3.24.2|
|io.quarkus|quarkus-tls-registry|3.24.2|
|io.quarkus|quarkus-transaction-annotations|3.24.2|
|io.quarkus|quarkus-vertx-http|3.24.2|
|io.quarkus|quarkus-vertx-latebound-mdc-provider|3.24.2|
|io.quarkus|quarkus-vertx|3.24.2|
|io.quarkus|quarkus-virtual-threads|3.24.2|
|io.rest-assured|json-path|5.5.5|
|io.rest-assured|rest-assured-common|5.5.5|
...
|io.smallrye.common|smallrye-common-annotation|2.12.2|
|io.smallrye.common|smallrye-common-classloader|2.12.2|
|io.smallrye.common|smallrye-common-constraint|2.12.2|
|io.smallrye.common|smallrye-common-cpu|2.12.2|
|io.smallrye.common|smallrye-common-expression|2.12.2|
|io.smallrye.common|smallrye-common-function|2.12.2|
|io.smallrye.common|smallrye-common-io|2.12.2|
|io.smallrye.common|smallrye-common-net|2.12.2|
|io.smallrye.common|smallrye-common-os|2.12.2|
|io.smallrye.common|smallrye-common-ref|2.12.2|
|io.smallrye.common|smallrye-common-vertx-context|2.12.2|
|io.smallrye.config|smallrye-config-common|3.13.2|
|io.smallrye.config|smallrye-config-core|3.13.2|
|io.smallrye.config|smallrye-config-source-yaml|3.13.2|
|io.smallrye.config|smallrye-config|3.13.2|
|io.smallrye.reactive|mutiny-smallrye-context-propagation|2.9.2|
|io.smallrye.reactive|mutiny-zero-flow-adapters|1.1.1|
|io.smallrye.reactive|mutiny|2.9.2|
|io.smallrye.reactive|smallrye-mutiny-vertx-auth-common|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-bridge-common|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-core|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-runtime|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-uri-template|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-web-common|3.19.1|
|io.smallrye.reactive|smallrye-mutiny-vertx-web|3.19.1|
|io.smallrye.reactive|smallrye-reactive-converter-api|3.0.3|
|io.smallrye.reactive|smallrye-reactive-converter-mutiny|3.0.3|
|io.smallrye.reactive|vertx-mutiny-generator|3.19.1|
|io.smallrye.stork|stork-api|2.7.3|
|io.smallrye|jandex|3.3.1|
...
|io.smallrye|smallrye-fault-tolerance-vertx|6.9.1|
|io.smallrye|smallrye-health-api|4.2.0|
|io.smallrye|smallrye-health-provided-checks|4.2.0|
|io.smallrye|smallrye-health|4.2.0|
|io.smallrye|smallrye-open-api-core|4.0.11|
|io.smallrye|smallrye-open-api-model|4.0.11|
|io.vertx|vertx-auth-common|4.5.16|
|io.vertx|vertx-bridge-common|4.5.16|
|io.vertx|vertx-codegen|4.5.16|
|io.vertx|vertx-core|4.5.16|
|io.vertx|vertx-uri-template|4.5.16|
|io.vertx|vertx-web-client|4.5.16|
|io.vertx|vertx-web-common|4.5.16|
|io.vertx|vertx-web|4.5.16|
|it.eng.parer|consumer-jms-fascicolo-v3|1.0.1-SNAPSHOT|
...
|org.apache.activemq|activemq-artemis-native|2.0.0|
...
|org.apache.activemq|artemis-jakarta-server|2.35.0|
|org.apache.activemq|artemis-jakarta-service-extensions|2.35.0|
...
|org.eclipse.microprofile.rest.client|microprofile-rest-client-api|4.0|
...
|org.hibernate.models|hibernate-models|1.0.0|
|org.hibernate.orm|hibernate-core|7.0.4.Final|
|org.hibernate.orm|hibernate-graalvm|7.0.4.Final|
...
|org.jgroups|jgroups|5.3.10.Final|
...
|org.wildfly.security|wildfly-elytron-asn1|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-auth-server|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-auth|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-base|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-credential|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-encryption|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-keystore|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-password-impl|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-permission|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-provider-util|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-realm|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-util|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-x500-cert-util|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-x500-cert|2.6.4.Final|
|org.wildfly.security|wildfly-elytron-x500|2.6.4.Final|
|org.yaml|snakeyaml|2.4|
|software.amazon.awssdk|annotations|2.30.37|
|software.amazon.awssdk|apache-client|2.30.37|
|software.amazon.awssdk|arns|2.30.37|
|software.amazon.awssdk|auth|2.30.37|
|software.amazon.awssdk|aws-core|2.30.37|
|software.amazon.awssdk|aws-query-protocol|2.30.37|
|software.amazon.awssdk|aws-xml-protocol|2.30.37|
|software.amazon.awssdk|checksums-spi|2.30.37|
|software.amazon.awssdk|checksums|2.30.37|
|software.amazon.awssdk|crt-core|2.30.37|
|software.amazon.awssdk|endpoints-spi|2.30.37|
|software.amazon.awssdk|http-auth-aws-eventstream|2.30.37|
|software.amazon.awssdk|http-auth-aws|2.30.37|
|software.amazon.awssdk|http-auth-spi|2.30.37|
|software.amazon.awssdk|http-auth|2.30.37|
|software.amazon.awssdk|http-client-spi|2.30.37|
|software.amazon.awssdk|identity-spi|2.30.37|
|software.amazon.awssdk|json-utils|2.30.37|
|software.amazon.awssdk|metrics-spi|2.30.37|
|software.amazon.awssdk|netty-nio-client|2.30.37|
|software.amazon.awssdk|profiles|2.30.37|
|software.amazon.awssdk|protocol-core|2.30.37|
|software.amazon.awssdk|regions|2.30.37|
|software.amazon.awssdk|retries-spi|2.30.37|
|software.amazon.awssdk|retries|2.30.37|
|software.amazon.awssdk|s3|2.30.37|
|software.amazon.awssdk|sdk-core|2.30.37|
|software.amazon.awssdk|third-party-jackson-core|2.30.37|
|software.amazon.awssdk|utils|2.30.37|

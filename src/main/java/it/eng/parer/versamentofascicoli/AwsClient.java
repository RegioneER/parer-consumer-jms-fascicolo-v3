...
public class AwsClient {
    ...
    @ConfigProperty(name = "vfb.s3.max-connections", defaultValue = "100")
    private String maxConnections;
    @ConfigProperty(name = "vfb.s3.connections-timeout-minutes", defaultValue = "1")
    private String connectionTimeoutOfMinutes;
    @ConfigProperty(name = "vfb.s3.socket-timeout-minutes", defaultValue = "10")
    private String socketTimeoutOfMinutes;
    ...
    private final Integer maxConnections() {
        return NumberUtils.isDigits(maxConnections) ? Integer.parseInt(maxConnections) : 100; // default
    }
    ...
    private final Duration connectionTimeoutOfMinutes() {
        return Duration.ofMinutes(NumberUtils.isDigits(connectionTimeoutOfMinutes)
                ? Long.parseLong(connectionTimeoutOfMinutes)
                : 1L); // default
    }
    ...
    private final Duration socketTimeoutOfMinutes() {
        return Duration.ofMinutes(NumberUtils.isDigits(socketTimeoutOfMinutes)
                ? Long.parseLong(socketTimeoutOfMinutes)
                : 10L); // default
    }
